	...
	<div class="grid grid-cols-12 gap-4">
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="mt-6">
					<h2 class="text-lg font-semibold mb-3 text-gray-700 dark:text-white">Payment Proof</h2>
					<p class="text-sm text-gray-600 dark:text-gray-400 mb-3">Please upload a screenshot or photo of your payment receipt</p>
