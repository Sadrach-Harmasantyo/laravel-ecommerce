<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="rounded-xl overflow-hidden shadow-lg">
                <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80" 
                     alt="Team working together" class="w-full h-full object-cover">
            </div>
        </div>
    </div>
    ...
    <div class="mb-16">
        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md text-center">
                <img src="https://randomuser.me/api/portraits/men/68.jpg" alt="Team Member" class="w-32 h-32 rounded-full mx-auto mb-4">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md text-center">
                <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Team Member" class="w-32 h-32 rounded-full mx-auto mb-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">info@tokoonline.com</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
